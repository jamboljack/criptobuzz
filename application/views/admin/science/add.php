            ...
            <div class="col-md-12">
                ...
                <div class="portlet box grey-steel">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-plus-circle"></i> Form Add Science
                        </div>
                    </div>
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <div class="input-icon right">
                                            <i class="fa"></i>
                                            <input type="text" class="form-control" name="url" id="url" placeholder="Input URL Video" autocomplete="off" />
...
$(document).ready(function() {
    ...
    $("#formInput").validate({
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                url: "<?=site_url('admin/science/savedata');?>",
                type: "POST",
                data: dataString,
                dataType: 'JSON',
