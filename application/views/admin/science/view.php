...
<script>
    function hapusData(science_id) {
        ...
        swal({
            ...
            if (!isConfirm) return;
            $.ajax({
                url : "<?=site_url('admin/science/deletedata')?>/"+id,
                type: "POST",
                dataType: "JSON",
            ...
            <div class="col-md-12">
                <div class="portlet box grey-steel">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-list"></i> Science List
                        </div>
                    </div>
                    <div class="portlet-body">
                        <a href="<?=site_url('admin/science/adddata');?>">
...
$(document).ready(function() {
    table = $('#tableData').DataTable({
        ...
        "order": [],
        "ajax": {
            "url": "<?=site_url('admin/science/data_list');?>",
            "type": "POST"
        },
        "columnDefs": [
        {
