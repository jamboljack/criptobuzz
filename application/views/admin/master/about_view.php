            ...
            <div class="col-md-12">
                ...
                <div class="portlet box grey-steel">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-edit"></i> Detail About Us
                        </div>
                    </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <div class="input-icon right">
                                            <i class="fa"></i>
                                            <textarea class="wysihtml5 form-control" rows="15" name="desc"><?=$detail->menu_desc;?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
$(document).ready(function() {
    ...
    $("#formInput").validate({
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                url: "<?=site_url('admin/about/updatedata');?>",
                type: "POST",
                data: dataString,
                dataType: 'JSON',
