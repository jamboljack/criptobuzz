    ...
    $("#formInput").validate({
        ...
        messages: {
            username: {
                ...
                remote: 'Username exist, please Change another'
            },
            password: {
                required:'Password required', minlength:'Minimal 5 Char'
            },
            name: {
                required:'Name required', minlength:'Minimal 5 Char'
            },
            mobile: {
                required:'Handphone required', minlength:'Minimal 11 Digit', number:'Only Number'
            },
            email: {
                required:'Email required', minlength:'Minimal 15 Char', email:'Email not Valid',
                remote: 'Email exist, please Change another'
            },
            lstLevel: {
