...
{
    public $table        = 'cripto_users';
    public $column_order = array(null, null, 'user_username', 'user_name', 'user_mobile', 'user_email',
        'user_level', 'user_status');
    public $column_search = array('user_username', 'user_name', 'user_mobile', 'user_email', 'user_level', 'user_status');
