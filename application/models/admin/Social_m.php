...
{
    public $table         = 'cripto_social';
    public $column_order  = array(null, null, 'social_name', 'social_class', 'social_url');
    public $column_search = array('social_name', 'social_class', 'social_url');
    ...
    public function insert_data()
    {
        ...
        $this->db->insert('cripto_social', $data);
    }
    ...
    public function update_data()
    {
        ...
        $this->db->update('cripto_social', $data);
    }

    public function delete_data($id)
    {
        $this->db->where('social_id', $id);
        $this->db->delete('cripto_social');
    }
}
